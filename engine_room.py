...
print(type(colors))
c = 'brown'
colors.append(c)  # courses.append(new)     
print(colors) # Appending new list to the old list
colors.sort
print(colors)
...
for id, item in enumerate(fruits):    # enumerate() returns index along with main data. Hence you need two variables at the left (id, item). These names could be any. 
  print(id, item)
...
# Dictionary
portfolio = {
    "name": "Shraddha Shinde","class":"M.Sc(IMCA)",
    "skills": "Python"
}
print(portfolio)
print(portfolio['name'])
del portfolio['skills']
print(portfolio)
